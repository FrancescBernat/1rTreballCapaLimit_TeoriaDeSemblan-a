...
fun.GraficsErrors(z0, k, err_H, color="twilight", ylab=r"\theta_0")
plt.savefig("Imatges/RMSE_H_zt"+output)
plt.title("H, variant z0 i t")

fun.GraficsErrors(z0, k, err_Le, color="twilight", ylab=r"\theta_0")
plt.savefig("Imatges/RMSE_Le_zt"+output)
plt.title("Le, variant z0 i t")

fun.GraficsErrors(z0, k, err_u, color="twilight", ylab=r"\theta_0")
...
fun.GraficsErrors(z0, k, err_H, color="CMRmap", xlab=r"\theta_0")
plt.savefig("Imatges/RMSE_H_tk"+output)
plt.title("H, variant t0 i k")

fun.GraficsErrors(z0, k, err_Le, color="CMRmap", xlab=r"\theta_0")
plt.savefig("Imatges/RMSE_Le_tk"+output)
plt.title("Le, variant t0 i k")

fun.GraficsErrors(z0, k, err_u, color="CMRmap", xlab=r"\theta_0")
